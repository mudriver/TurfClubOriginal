...
@RequestMapping(value = "/codeBuilder")
public class VetReportContoller {

	static Logger logger = LoggerFactory.getLogger(VetReportContoller.class);
	...
	@RequestMapping(value = "/buildApp", method = RequestMethod.GET)
	public ModelAndView horsesOnAlert() {
		...
		List<String> horsesOnAlert = dbservice.getCatelogNames("");
		modelAndView.addObject("vetreportAlertHorses", horsesOnAlert);
	 ...
	 * dateTime + responseCode + responseText + "1790testestablished" ;
